...
namespace SrcChess2.Core {
    ...
    public sealed class ChessBoard {
        ...
        public ChessBoard(Dispatcher dispatcher) {
        ...
        public GameResult DoMove(MoveExt move) {
            GameResult   retVal = GameResult.OnGoing;
        ...
        public List<Move>? EnumMoveList(PlayerColor playerColor, bool isMoveListNeeded) {
            List<Move>? retVal;
            PieceType   pieceType;
            bool        isBlackToMove;
