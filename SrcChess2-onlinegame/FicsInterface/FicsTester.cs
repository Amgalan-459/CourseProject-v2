...
namespace SrcChess2.FicsInterface {
    ...
    public class FicsTester {
        ...
        private class GameIntfTest(FicsGame               game,
                                   ChessBoardControl      chessBoardControl,
                                   System.IO.StreamWriter streamLog,
                                   EventWaitHandle        eventWaitHandle,
                                   int                    moveTimeOut,
                                   Action<FicsGameIntf>   moveTimeOutAction) : FicsGameIntf(game, chessBoardControl, moveTimeOut, moveTimeOutAction, gameFinishedAction: null) {
            /// <summary>Stream use to log error and message</summary>
            private readonly System.IO.StreamWriter m_streamLog = streamLog;

            /// <summary>
            /// Use to inform background runner the game is terminating
            /// </summary>
            public EventWaitHandle EventWaitHandle { get; private set; } = eventWaitHandle;
